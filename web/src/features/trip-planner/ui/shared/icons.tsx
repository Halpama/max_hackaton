...
export function PencilIcon(props: IconProps) {
    return (
        ...
        >
            <path
                d="m5 16.8-.8 3.1 3.1-.8L18.4 8a2.1 2.1 0 0 0-3-3L5 16.8Z"
                stroke="currentColor"
                strokeWidth="1.8"
                strokeLinejoin="round"
            />
            <path d="m14.1 6.9 3 3" stroke="currentColor" strokeWidth="1.8" />
        </svg>
    );
}
...
export function TrashIcon(props: IconProps) {
    return (
        ...
        >
            <path
                d="M5 7.5h14M10 4.5h4l1 3H9l1-3ZM7 7.5l.8 12h8.4l.8-12M10.5 11v5M13.5 11v5"
                stroke="currentColor"
                strokeWidth="1.8"
                strokeLinecap="round"
                strokeLinejoin="round"
