...
2. **create** — первое создание на `/trips/new` (остаёшься на форме и заполняешь сам)  
3. **prefs** — первый экран интересов/темпа  
4. **route** — первый успешный маршрут  

Повтор в dev: `?onboarding=home|create|prefs|route`, чипы «Тоша · demo» / «reset all»,  
