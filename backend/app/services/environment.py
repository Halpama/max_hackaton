...
IGNORED_KINDS = {"attractions", "sights", "interesting_places", "kids", "recreation"}
...
MIXED_WORDS = {
    "кремль", "крепость", "усадьба", "дворец", "монастырь", "собор", "заповедник",
    "церковь", "мечеть", "синагога", "храм", "пасаж", "пассаж", "гостиный двор",
    "фортификация", "бастион", "башня", "тарханы",
}
